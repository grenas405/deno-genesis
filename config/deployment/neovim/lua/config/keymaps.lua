...
map("n", "<leader>dp", "<cmd>Telescope projects<cr>", { desc = "Projects" })
map("n", "<leader>dR", "<cmd>DenoRun<space>", { desc = "Deno Run (input)" })
map("n", "<leader>dT", "<cmd>DenoTest<space>", { desc = "Deno Test (input)" })
map("n", "<leader>dI", "<cmd>DenoInfo<space>", { desc = "Deno Info (input)" })
map("n", "<leader>dC", "<cmd>DenoCache<space>", { desc = "Deno Cache (input)" })

-- Rest client mappings
map("n", "<leader>rr", "<cmd>Rest run<cr>", { desc = "Run request under cursor" })
map("n", "<leader>rl", "<cmd>Rest run last<cr>", { desc = "Re-run last request" })
map("n", "<leader>rp", "<cmd>Rest run<cr>", { desc = "Preview request" })

-- Enhanced Deno development mappings
map("n", "<leader>dw", function()
  vim.cmd("TermExec cmd='deno run --watch --allow-all " .. vim.fn.expand("%") .. "'")
end, { desc = "Watch current file" })

map("n", "<leader>db", function()
  vim.cmd("TermExec cmd='deno bench --allow-all'")
end, { desc = "Run benchmarks" })

map("n", "<leader>dd", function()
  vim.cmd("TermExec cmd='deno doc --json --name='' " .. vim.fn.expand("%") .. "'")
end, { desc = "Generate docs for current file" })

map("n", "<leader>ds", function()
  vim.cmd("TermExec cmd='deno task start'")
end, { desc = "Start Deno task" })
